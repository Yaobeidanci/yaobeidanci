...
public class ChooseBook extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data.add(new BookItemEntity(ConstantConfig.CET6_MOST,ConstantConfig.bookNameById(ConstantConfig.CET6_MOST),ConstantConfig.wordTotalNumberById(ConstantConfig.CET6_MOST),ConstantConfig.bookPicById(ConstantConfig.CET6_MOST),ConstantConfig.bookIntrById(ConstantConfig.CET6_MOST)));
        data.add(new BookItemEntity(ConstantConfig.CET6_ALL,ConstantConfig.bookNameById(ConstantConfig.CET6_ALL),ConstantConfig.wordTotalNumberById(ConstantConfig.CET6_ALL),ConstantConfig.bookPicById(ConstantConfig.CET6_ALL),ConstantConfig.bookIntrById(ConstantConfig.CET6_ALL)));
        ...
        data.add(new BookItemEntity(ConstantConfig.GRE,ConstantConfig.bookNameById(ConstantConfig.GRE),ConstantConfig.wordTotalNumberById(ConstantConfig.GRE),ConstantConfig.bookPicById(ConstantConfig.GRE),ConstantConfig.bookIntrById(ConstantConfig.GRE)));
