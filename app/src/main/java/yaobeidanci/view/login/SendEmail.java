...
public class SendEmail {
    ...
    // 发件人
    private String from = "mushroomlos@163.com";
    // 收件人
    private String to = "1360741742@qq.com";
    // 初始化连接邮件服务器的会话信息
    ...
    public void sendTextEmail(long Num) throws Exception {
        ...
        // 打开连接
        transport.connect("1158295879@qq.com", "JJBSMQQDYWYEIZXN");
    ...
    public void sendHtmlEmail(long Num) throws Exception {
        ...
        message.setContent("<span style='color:blue;'>欢迎您使用要背单词app，您本次的验证码为：</span>"+"<span style='color:red;'>"+Num+"</span>",
    ...
    static class MyAuthenticator extends Authenticator {
        ...
        private String username = "mushroomlos@163.com";

        private String password = "JJBSMQQDYWYEIZXN";
